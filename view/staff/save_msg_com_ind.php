...
if($_POST['msg']!=''){
    ...
    if($result){
        ...
        $result = $stmt->execute();
        if($result){
            //echo "<script>console.log('save_msg_com_ind');</script>";

            //echo "<br>".$_POST['msg'];
            //echo "<script>console.log('".$_POST['msg']."');</script>";
            echo "<script>sendMessageComInd('".$_POST['msg']."', '".$_POST['rem']."', $destChat, '".$_POST['com']."', '".$_POST['nome']."', '".$_POST['img']."', '".$_POST['tk']."');</script>";
        }
    }
}
