<?php
    ...
    $sql="SELECT a.campo_id as id_campo, a.fila_id as id_fila, b.nome_fila, a.input_id, c.nome_input, c.tipo_input, d.desc_campo, d.nome_campo, a.ativo, a.qualif, a.date_time, a.ordem, a.obg FROM tbl_forms_mon_input_campo_cnf a, tbl_config_fila b, tbl_forms_mon_input c, tbl_forms_mon_input_campo d where a.fila_id=? and a.fila_id=b.id_fila and a.input_id=c.id_input and a.campo_id=d.id_campo order by ordem asc";
    //echo "<br>".$sql;
  ...
  <?php
            ...
            for($y=0;$y<count($info);$y++){
                ...
                echo "<div class='row'>";
                    ...
                    echo "<div class='col-4 $tbl_color'>".stHtml($info[$y]['desc_campo'])."</div>";
                    echo "<div class='col-3 $tbl_color'><center>".stHtml($info[$y]['nome_input'])."</center></div>";
                    /*
