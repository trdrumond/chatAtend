<?php
    ...
    $sql="SELECT id_option, fila_id, campo_id, desc_option, referencia, value_option, ativo from tbl_forms_pos_input_option where fila_id=".$info['fila_id']." and campo_id=".$info['campo_id']." and input_id=".$info['input_id']." order by desc_option asc";
    //echo "<br>".$sql;
