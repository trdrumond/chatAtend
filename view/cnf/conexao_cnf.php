...
if ($host === '' || $usuario === '' || $banco === '') {
    error_log('piloto_2.0 conexao_cnf: copie conexao.local.example.php para conexao.local.php');
...
try {
    ...
    error_log('piloto_2.0 conexao_cnf PDO: ' . $e->getMessage());
...
try {
    ...
    error_log('piloto_2.0 conexao_cnf PDO_LOAD: ' . $e->getMessage());
    die('Falha ao conectar ao banco de dados.');
}
