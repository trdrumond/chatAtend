...
echo '['.date('d/m/Y H:i:s')."] -> OK - tbl_chat_fila_secondary ".count($info1)." /n";
...
echo '['.date('d/m/Y H:i:s')."] -> OK - tbl_chat_info_secondary ".count($info2)." /n";
...
echo '['.date('d/m/Y H:i:s')."] -> OK - tbl_log_atendimento_secondary ".count($info7)." /n";
...
echo '['.date('d/m/Y H:i:s')."] -> OK - tbl_tma_atend_secondary ".count($infoTma)." /n";
