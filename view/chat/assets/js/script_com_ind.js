...
if( typeof com !== 'undefined'){
    //console.log('com: ' + com);
            ...
            function saveMsgComMassa(msg, rem, dest, com, nome, img, tk){

                if (msg != '') {
                    var feed = '#feed_massa_' + com;
            ...
            function sendMessageComInd(message, rem, dest, com, nome, img, tk){
                //console.log('sendMessageComInd');
                if (message != '') {
                    var data = new Date();
            ...
            function showMessagesComInd(how, data, com) {
                var chatId=com;
                ...
                if($('#chat-content_com_' + chatId).length){
                    ...
                    if(how !=='sys'){
                        ...
                        function loadTextCom(msg, chatId){
                            $.post("staff/loadText_com_ind.php",
                            {
                                msg, chatId, how
                            },
                            function (valor) {
