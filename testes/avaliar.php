...
$arquivo = 'C:\\xampp\\htdocs\\ia_scripts\\39528.txt';
...
// Corrige encoding para UTF-8
$respostaJson = mb_convert_encoding($respostaJson, 'UTF-8', 'auto');
...
if (json_last_error() === JSON_ERROR_NONE) {
    ...
    // Exibe o sugestao e o score
    if (isset($resultado['sugestao'])) {
        echo "<p><strong>Sentimento:</strong> " . $resultado['sugestao'] . "</p>";
    }
    echo "</ul>";
} else {
